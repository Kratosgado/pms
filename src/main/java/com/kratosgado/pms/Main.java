...
public class Main {
  ...
  public static void main(final String[] args) {
    final UserInMemoryDatabase usersDb = new UserInMemoryDatabase("users.json", Seed.seedUsers());
    // final TaskInMemoryDatabase tasksDb = new
    // TaskInMemoryDatabase(Seed.seedTasks());
    final ProjectInMemoryDatabase projectsDb = new ProjectInMemoryDatabase("projects.json", Seed.seedProjects());
